...
class Trim implements PluginInterface
{
     ...
     * @return bool
     */
    private function validateColor($colors): bool
    {
     ...
     * @return bool
     */
    private function validateSides($sidesString): bool
    {
     ...
     * @param string $sides
     */
    public function __construct(array $color = array(255, 255, 255), string $sides = 'TBLR')
    {
